;(function($, exports, undefined){
    ...
    $.fn.viSimpleSlider = function(option){
        ...
        if(setVal.desktopSwipe){
            ...
            swipeslide = false;
            if(touchsupport)swipeslide = true;
        }
        var SimpleSlider = {
            /***********************************************************************************         1. 슬라이드 생성          ************/
            mkSlide : function(e){
...
//                    console.log('Xposition ' + Xposition[Num])
        ...
        var makeDepth = {
            ...
            /***********************************************************************************         (옵션) 화살표 만들기          ************/
            mkArrow : function(e){
                if($this.find('a.arrowBtn.prev').length == 0)$('<a href="#"><span class="fa fa-angle-left"></span></a>').appendTo($this).addClass('arrowBtn prev');
                if($this.find('a.arrowBtn.next').length == 0)$('<a href="#"><span class="fa fa-angle-right"></span></a>').appendTo($this).addClass('arrowBtn next');
...
//                                console.log(thiscurrent)
        ...
        var slidefunc = {
            ...
            slideMotion : function(targetIndex){
                ...
                if(settings.indicate && maxSlide > 1){$this.find('.indicate').find('>a').eq(thiscurrent).addClass('active').siblings().removeClass('active');}
